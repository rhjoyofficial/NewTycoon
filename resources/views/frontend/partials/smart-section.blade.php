        ...
        @if ($smartSection['special'])
            ...
            <div class="relative w-full h-[40rem] overflow-hidden rounded-2xl">
                ...
                <div class="relative z-10 flex flex-col items-center justify-start h-full text-center text-black py-12">
                    <h3 class="text-2xl md:text-5xl font-bold mb-4 font-sans">{{ $smartSection['title'] }}</h3>
                    <p class="text-lg md:text-xl mb-6 font-sans">{{ $smartSection['description'] }}</p>
        ...
        @else
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-6 items-center">
             ...
             h-full flex flex-col justify-between">
                    <div>
                        <h3 class="text-5xl font-semibold text-gray-900 mb-4 font-sans">{{ $smartSection['title'] }}
                        </h3>
                        <p class="text-gray-600 text-lg mb-6 font-sans">{{ $smartSection['description'] }}</p>
                    </div>
                    <a href="{{ $smartSection['button_url'] ?? '#' }}"
